...
void loop() 
{
    ...
    //DONE: Um, could be caused by bt module being 3.3v in regards to logic... need to check
    //DONE:remember pull down resistors for logic pins... or maybe we need voltage dividers on rx?
    //probably should implement reconnect feature on manual communication though
    //DONE: could be caused by sudden low voltage on bluetooth module when we wind up motors? put in capacitor? some people had problems when U > 9 V
